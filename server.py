...
import Authenticate.users as users,Authenticate.org_users as org_users,Authenticate.orgnization as orgnization
...
urls=(
    ...
    '/customer',customer.app_customer,
    '/orgnization',orgnization.app_orgnization,
)
