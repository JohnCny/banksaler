...
"url"){if(d=="link"&&M(b)===""){z(b,"必须先选择链接对象。",c);return false}j.children(":button").unbind(q).bind(q,function(){var k=j.find(":text"),o=e.trim(k.val());o!==""&&v(b,g.command,o,null,g.button);k.val("http://");r();w(b)})}else f=="pastetext"&&j.children(":button").unbind(q).bind(q,function(){var k=j.find("textarea"),o=k.val().replace(/\n/g,"<br />");o!==""&&v(b,g.command,o,null,g.button);k.val("");r();w(b)});if(c!==e.data(i,A)){N(b,i,c);return false}return}else if(d==
...
g){e(m).appendTo(f).html(g[1]+g[0]+g[1].replace("<","</"))});else if(a=="url"){f.html('输入连接:<br><input type=text value="http://" size=35><br><input type=button value="提交">');c=B}else if(a=="pastetext"){f.html("将你的内容粘贴到文本框内，然后点击提交！<br /><textarea cols=40 rows=3></textarea><br /><input type=button value=提交>");c=B}if(!c&&!d)c=S;f.addClass(c);l&&f.attr(I,"on").find("div,font,p,h1,h2,h3,h4,h5,h6").attr(I,"on");if(f.hasClass(S)||h===true)f.children().hover(O,P);p[a]=f[0];
...
colors:"FFF FCC FC9 FF9 FFC 9F9 9FF CFF CCF FCF CCC F66 F96 FF6 FF3 6F9 3FF 6FF 99F F9F BBB F00 F90 FC6 FF0 3F3 6CC 3CF 66C C6C 999 C00 F60 FC3 FC0 3C0 0CC 36F 63F C3C 666 900 C60 C93 990 090 399 33F 60C 939 333 600 930 963 660 060 366 009 339 636 000 300 630 633 330 030 033 006 309 303",fonts:"宋体,黑体,楷体_GB2312,仿宋_GB2312,微软雅黑,Arial,Courier New,Narrow,Garamond,Georgia,Impact,Sans Serif,Serif,Tahoma,Trebuchet MS,Verdana",sizes:"1,2,3,4,5,6,7",styles:[["正文","<p>"],["标题1","<h1>"],["标题2","<h2>"],
["标题3","<h3>"],["标题4","<h4>"],["标题5","<h5>"],["标题6","<h6>"]],useCSS:false,docType:'<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">',docCSSFile:"",bodyStyle:"margin:4px; font:10pt Arial,Verdana; cursor:text"},buttons:{init:"bold,加粗,|italic,倾斜,|underline,下划线,|strikethrough,删除线,|subscript,下标,|superscript,上标,|font,字体,fontname,|size,字体大小,fontsize,|style,样式,formatblock,|color,字体颜色,forecolor,|highlight,突出显示,hilitecolor,color|removeformat,删除所有样式,|bullets,项目符号,insertunorderedlist|numbering,编号,insertorderedlist|outdent,减少缩进量,|indent,增加缩进量,|alignleft,左对齐,justifyleft|center,居中对齐,justifycenter|alignright,右对齐,justifyright|justify,两端对齐,justifyfull|undo,后退,|redo,前进,|rule,插入水平线,inserthorizontalrule|image,插入图片,insertimage,url|link,添加链接,createlink,url|unlink,移除链接,|cut,剪切,|copy,复制,|paste,粘贴,|pastetext,粘贴文本,inserthtml,|print,打印,|source,显示代码"},
